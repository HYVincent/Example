    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_TIME_TICK)) {
                ...
                ToastUtil.showSingleTextToast(getApplicationContext(), curDate.toString());
                ...
                if(!AppUtil.isServiceRunning(JulieService.this,"com.common.libary.service.ProtectService")){
                    startService(new Intent(JulieService.this,ProtectService.class));
                    MyLog.d(JulieService.class.getSimpleName(),"监测到ProtectService未运行，启动ProtectService");
                }else {
                    MyLog.d(JulieService.class.getSimpleName(),"ProtectService正在运行...");
                }
            }
        }
    };
