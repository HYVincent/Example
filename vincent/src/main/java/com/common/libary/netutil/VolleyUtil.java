...
public class VolleyUtil {
    ...
    public static void addToRequestQueue(Context context,String tag, Request req) {
    ...
    public static void addToRequestQueue(Context context,Request req) {
        // set the default tag if tag is empty
        req.setTag(TAG);
        VolleyLog.d("请求URL: %s", req.getUrl());
        getRequestQueue(context).add(req);
     ...
     * 返回数据为String
     */
    public static void getStringRequest(Context context,String tag, String url,
        ...
        addToRequestQueue(context,tag, req);
    }
     ...
     * 返回数据为String
     */
    public static void postStringRequest(Context context,String tag, String url,
     ...
     * 返回数据为JsonObject
     */
    public static void getJsonObjectRequest(Context context,String tag, String url,
     ...
     * 返回数据为JsonObject
     */
    public static void postJsonObjectRequest(Context context,String tag, String url,
     ...
     * 返回数据为String
     */
    public static void postStringNormalRequest(Context context,String tag, String url,
                                               Map<String, String> paramMap,
                                               Response.Listener<String> onResponse,
                                               Response.ErrorListener onErrorResponse) {
     ...
     * 返回数据为JsonObject
     */
    public static void postJSONObjectNormalRequest(Context context,String tag, String url,
                                                   Map<String, String> paramMap,
                                                   Response.Listener<JSONObject> onResponse,
                                                   Response.ErrorListener onErrorResponse) {
...
*/
   ...
   /* public static void uploadListFileRequest(final String tag,
     ...
     */
    public static void postXMLRequest(Context context,String tag, String url,
                                      Map<String, String> paramMap,
                                      Response.Listener<JSONObject> onResponse,
                                      Response.ErrorListener onErrorResponse) {
