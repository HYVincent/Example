package com.vincent.libary.util;
...
//        tv.setText("SD卡总容量:"+totalSize+"\nSD卡可用容量:"+availableSize+"\n"+getRomSpace());
     ...
     * 跳转到华为手机管家悬浮窗权限管理页面
     */
    public static void goHuaWeiSetting(Context context,String errMsg) {
        try {
...
//   ComponentName comp = new ComponentName("com.android.settings","com.android.settings.permission.single_app_activity");//此处可跳转到指定app对应的权限管理页面，但是需要相关权限，未解决
            ...
            //抛出异常时提示信息
            e.printStackTrace();
            ToastUtil.showSingleTextToast(context.getApplicationContext(),errMsg);
        }
    }
     ...
     */
    public static void goHWWindowPermission(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     */
    public static void goHWSelfMotionStartManager(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            ToastUtil.showSingleToastCenter(context,errMsg);
            e.printStackTrace();
        }
    }
    /**
     ...
     */
    public static void goRelevanceStartManager(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     */
    public static void goProtectAppManager(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     */
    public static void goNotificationManager(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     */
    public static void goClearMemory(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     */
    public static void goInterceptionAct(Context context,String errMsg){
        try {
            Intent intent = new Intent("com.vincent.julie");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//            finishTask.invoke(student, "数学");
     ...
     * @param context
     */
    public static void getInputKeyboard(final Context context){
        try {
     ...
     * 关闭键盘
     */
    public static void closeInputKeyBoard(final Context context,final Activity activity){
        try {
            new Thread(new Runnable() {
                @Override
                public void run() {
     ...
     */
    public static String getScreenParameterWidth(Context context) {
        try {
     ...
     * created at 2016/9/26 11:54
     */
    public static String getScreenParameterHeight(Context context) {
        try {
            DisplayMetrics metric = new DisplayMetrics();
            WindowManager mWindowManager = (WindowManager)context.getSystemService(Context.WINDOW_SERVICE);
            mWindowManager.getDefaultDisplay().getMetrics(metric);
